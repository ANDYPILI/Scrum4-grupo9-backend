		...
		<main>
			...
			<!--<div
				...
				<div class="col-xl-12 col-lg-12 col-md-12">
					<div class="card mb-4">
						 Cargando mi hoja de estilo  <div class="card-header text-white bg-dark">
							 Registrar una nueva venta
						</div>-->

				<div class="card bg-dark text-white">
        <img class="card-img" src="https://cdn.pixabay.com/photo/2016/02/17/19/08/lotus-1205631_960_720.jpg" opacity=0. alt="Card image">
...
<!-- Producto 1 -->
                        ...
                        <button type="button" class="btn btn-info text-white"
									...
									<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
										<div class="input-group input-group-sm mb-3">
											<span class="input-group-text" id="basic-addon1">Precio</span> <input type="text" class="form-control" id="valtotal1"
...
<!-- producto 2 -->
                        ...
                        <button type="button" class="btn btn-info text-white"
									...
									<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
										<div class="input-group input-group-sm mb-3">
											<span class="input-group-text" id="basic-addon1">Precio</span> <input type="text" class="form-control" id="valtotal2"
												readonly="readonly" value="0">
										</div>
									</div>
...
<!-- producto 3 -->
                        ...
                        <button type="button" class="btn btn-info text-white"
									...
									<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
										<div class="input-group input-group-sm mb-3">
											<span class="input-group-text" id="basic-addon1">Precio</span> <input type="text" class="form-control" id="valtotal3"
												readonly="readonly" value="0">
										</div>
									</div>
								</div>
...
<!-- Sumatorias de la venta-->
								...
								<div class="row justify-content-end mt-3">
									<div class="col-xl-3 col-lg-3 col-md-7 col-sm-8">
										<div class="input-group input-group-sm mb-3">
											<span class="input-group-text" id="basic-addon1">Subtotal venta</span> <input type="text" class="form-control"
												id="total_venta">
										</div>
									</div>
								</div>
								...
								<div class="row justify-content-end mt-3">
									<div class="col-xl-3 col-lg-3 col-md-7 col-sm-8">
										<div class="input-group input-group-sm mb-3">
											<span class="input-group-text" id="basic-addon1">Total a pagar </span> <input type="text" class="form-control"
												id="total_venta_iva">
										</div>
									</div>
								</div>
